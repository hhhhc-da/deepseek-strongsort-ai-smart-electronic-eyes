...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/magic/': RouteRecordInfo<
      ...
      | never
    >,
    '/magic/componets/ChangeLiveSoureDrawer': RouteRecordInfo<
      '/magic/componets/ChangeLiveSoureDrawer',
      '/magic/componets/ChangeLiveSoureDrawer',
      Record<never, never>,
      Record<never, never>,
      | never
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/magic/index.vue': {
      routes:
        | '/magic/'
      views:
        | never
    }
    'src/pages/magic/componets/ChangeLiveSoureDrawer.vue': {
      routes:
        | '/magic/componets/ChangeLiveSoureDrawer'
      views:
        | never
