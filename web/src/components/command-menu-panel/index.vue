  ...
  <div>
    ...
    >
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs font-semibold text-muted-foreground">{{ t('nav.command.searchMenu') }}</span>
      </div>
    ...
    <UiCommandDialog v-model:open="open">
      <UiCommandInput :placeholder="t('nav.command.inputPlaceholder')" />
      <UiCommandList>
        <UiCommandEmpty>
          <Empty>
            <EmptyHeader>
              ...
              <EmptyTitle>{{ t('nav.command.emptyTitle') }}</EmptyTitle>
              <EmptyDescription>
                {{ t('nav.command.emptyDescription') }}
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        </UiCommandEmpty>
