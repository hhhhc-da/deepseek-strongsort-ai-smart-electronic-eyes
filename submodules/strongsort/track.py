...
# python track.py --source rtmp://192.168.43.234:1935/live/114514 --output rtmp://192.168.43.234:1935/live/1919810 --class 0 1 2 3 5 7 9 --save-vid
# python track.py --source E:\pandownload1\ML\Police\Traffic\ValidVideo\valid.mp4 --save-vid
    ...
    try:
        ...
        for frame_idx, (path, im, im0s, vid_cap) in enumerate(dataset):
            ...
            for i, det in enumerate(pred):  # detections per image
                    ...
                    if len(outputs[i]) > 0:
                        for j, (output, conf) in enumerate(zip(outputs[i], confs)):
                            ...
                            if True: #lzs save_txt
                                ...
                                with open('.\\runs\\test.txt', 'a') as f: #by lzs added
                                    #print(txt_path + '.txt')    #by lzs
                ...
                with open(os.path.join("runs", "pack.txt"), 'w+') as f:
                    f.write(str(tr)) 
...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', nargs='+', type=str, default=WEIGHTS / 'nanoka-car-valid.pt', help='model.pt path(s)')
