...
def environment_explore(cache=os.path.join(".cache", "lane.jpg"), txt_path=os.path.abspath(os.path.join(".cache", "lane.txt")), names={}):
    '''
...
def lane_mask_create(img_wh=(640, 720), px_stop_line=[[]], px_lane_info=[[]], save_path=os.path.abspath(os.path.join(".cache", "mask_lane.jpg"))):
    '''
    用于生成车道线类型掩膜, 用于标识区域
    '''
    img_h, img_w = img_wh
