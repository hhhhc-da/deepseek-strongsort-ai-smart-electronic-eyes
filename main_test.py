...
from modules.analyzer import AttackAnalyzer, BehaviorAnalyzer, EnvAnalyzer
...
if __name__ == "__main__":
    ...
    if not any([opt.all, opt.strongsort, opt.processor, opt.attack, opt.behavior, opt.deepseek, opt.llmmanager, opt.mqtt, opt.smtp, opt.report, opt.env]):
